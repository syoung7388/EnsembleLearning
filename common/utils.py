...
def getdata(root_dir, batch_size, resize):
    ...
    train_dataset = datasets.CIFAR10(root = root_dir, train = True, transform = train_transforms)
    test_dataset = datasets.CIFAR10(root = root_dir, train = False, transform = test_transforms)
